      ...
      typography: ({ theme }: { theme: (path: string) => string }) => ({
        DEFAULT: {
          css: {
            ...
            // Remove default margins from paragraphs inside lists for checklist items
            'ul > li > p': { marginTop: '0', marginBottom: '0' },
            'ol > li > p': { marginTop: '0', marginBottom: '0' },
            // Custom styling for GFM task list items (checkboxes)
            'input[type="checkbox"]': {
              marginRight: '0.5em',
              // Add more styles if needed, but usually handled by ShadCN Checkbox
            },
          },
        },
      }),
